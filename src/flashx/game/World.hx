...
class World
{
	public function new()
	{
		this.player_list = new List<flashx.game.Player>();
		//this.player_id_list = new flash.Vector<Int>(0, true);
		this.object_list = new List<flashx.game.Object>();
		this.npc_list = new List<flashx.game.NPC>();
		
		this.scene = new flashx.graphics.Scene<flashx.graphics.Object>();
	}
	
	public function find_player(id:Int):flashx.game.Player
	{
	...
	public inline function get_player(id:Int):flashx.game.Player
	{
		return this.find_player(id);
	}
	
	public inline function add_player(player:flashx.game.Player):Void
	{
		this.player_list.add(player);
		//this.player_list[player.id] = player;
	}
	
	public inline function remove_player(player:flashx.game.Player):Void
	{
	...
	public function update(time:flashx.core.Timestamp):Void
	{
		...
		{
			//var object:flashx.game.Object = this.object_list[i];
		...
		for(player in this.player_list)
		{
			//var player:flashx.game.Player = this.player_list[i];
		...
		{
			//var npc:flashx.game.NPC = this.npc_list[i];
...
/*
	...
	public var scene:flashx.graphics.Scene<flashx.graphics.Object>;
	public var object_list:List<flashx.game.Object>;
	public var player_list:List<flashx.game.Player>;
	public var npc_list:List<flashx.game.NPC>;
}
