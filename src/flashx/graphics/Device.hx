...
this.v1 = new flash.Vector<UInt>(display_width*display_height);
	...
	{
		this.display = new flashx.graphics.Display(width, height);
	...
	{
		this.viewport = new flashx.graphics.Viewport(0, 0, width, height);
...
this.screen.lock();
	...
	public var viewport:flashx.graphics.Viewport;
