...
class Service extends flaxe.ServiceBase
{
	...
	public function new(application:flaxe.Application, display_width:Int, display_height:Int, viewport_width:Int, viewport_height:Int)
	{
		this.layer = layer;
		
		this.render_event = new flaxe.Event();

		this.buffer = new flash.Vector<UInt>(display_width * display_height);
